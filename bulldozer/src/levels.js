...
export const LEVELS = [
  ...
  {
    title: "Der Engpass",
    rows: ["#########", "#P______#", "#___#___#", "#___#___#", "#_______#", "#___#___#", "#___#___#", "#########"],
    targets: [[6, 5]],
    boxes: [[2, 2]],
    player: [1, 1],
  },
  {
    title: "Zwei Kammern",
    rows: ["###########", "#P____#___#", "#_____#___#", "#_____#___#", "#__________", "#_____#___#", "#_____#___#", "###########"],
    targets: [[8, 5], [8, 2]],
    boxes: [[2, 2], [2, 5]],
    player: [1, 1],
  },
  {
    title: "Reihenfolge zaehlt",
    rows: ["########", "#P_____#", "#______#", "#___#__#", "#_B_#__#", "#_______", "#___#__#", "########"],
    targets: [[5, 2], [2, 6]],
    boxes: [[2, 4], [5, 5]],
    player: [1, 1],
  },
  {
    ...
    rows: ["#########", "#P______#", "#___##__#", "#_B_##_B#", "#___##__#", "#_______#", "#########"],
    targets: [[2, 5], [6, 1]],
    boxes: [[2, 3], [6, 3]],
    player: [1, 1],
  },
  {
    title: "Kreuzgang",
    rows: ["###########", "#P__#__#__#", "#___#__#__#", "#___#__#__#", "#_________#", "#___#__#__#", "#___#__#__#", "###########"],
    targets: [[2, 5], [6, 2], [9, 5]],
    boxes: [[2, 2], [6, 5], [9, 2]],
    player: [1, 1],
  },
