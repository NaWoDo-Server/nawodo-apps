    ...
    <div className="min-h-screen pb-28" style={{ backgroundColor: PAPER, color: INK, fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <div className="px-5 lg:px-8 pt-6 pb-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button onClick={() => setShowSettings(true)} className="w-9 h-9 rounded-full flex items-center justify-center font-semibold text-sm text-white flex-shrink-0 overflow-hidden" style={{ backgroundColor: INK }}>{avatarUrl ? <img src={avatarUrl} alt="" className="w-full h-full object-cover" /> : initial}</button>
        </div>
      </div>
